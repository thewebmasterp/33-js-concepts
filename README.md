<h1 align="center">
<br>
  <a href="https://github.com/leonardomso/33"><img src="https://i.imgur.com/dsHmk6H.jpg" alt="33 концепции, които всеки JavaScript програмист трябва да владее" width=200" /></a>
  <br>
    <br>
...
Това хранилище беше създадено с цел да помогне на програмистите да усъвършенстват JavaScript разбиранията си. То не е задължително четиво, а по-скоро наръчник за бъдещи учения. Базирано и вдъхновено е от [Stephen Curtis](https://twitter.com/stephenthecurt) и може да го прочетете [тук](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 Номиниран от GitHub като един от [топ проекти с отворен код за 2018!](https://blog.github.com/2018-12-13-new-open-source-projects/)**
...
- [Shqip (Албански)](https://github.com/eldrinf/33-js-concepts-albanian.git) — Eldrin Ereqi
- [اَلْعَرَبِيَّةُ‎ (Арабски)](https://github.com/amrsekilly/33-js-concepts) — Amr Elsekilly
- [汉语 (Китайски)](https://github.com/stephentian/33-js-concepts) — Re Tian
- [Português do Brasil (Бразилско Португалски) ](https://github.com/tiagoboeing/33-js-concepts) — Tiago Boeing
- [한국어 (Корейски)](https://github.com/yjs03057/33-js-concepts.git) — Suin Lee
- [Español (Испански)](https://github.com/adonismendozaperez/33-js-conceptos) — Adonis Mendoza
- [Türkçe (Турски)](https://github.com/ilker0/33-js-concepts) — İlker Demir
- [русский язык (Руски)](https://github.com/gumennii/33-js-concepts) — Mihail Gumennii
- [Tiếng Việt (Виетнамски)](https://github.com/nguyentranchung/33-js-concepts) — Nguyễn Trần Chung
- [Polski (Полски)](https://github.com/lip3k/33-js-concepts) — Dawid Lipinski
- [فارسی (Персийски)](https://github.com/majidalavizadeh/33-js-concepts) — Majid Alavizadeh
- [Bahasa Indonesia (Индонезийски)](https://github.com/rijdz/33-js-concepts) — Rijdzuan Sampoerna
- [Français (Френски)](https://github.com/robinmetral/33-concepts-js) — Robin Métral
- [हिन्दी (Хинди)](https://github.com/vikaschauhan/33-js-concepts) — Vikas Chauhan
- [Ελληνικά (Гръцки)](https://github.com/DimitrisZx/33-js-concepts) — Dimitris Zarachanis
- [日本語 (Японски)](https://github.com/oimo23/33-js-concepts) — oimo23
- [Deutsch (Немски)](https://github.com/burhannn/33-js-concepts) — burhannn
- [украї́нська мо́ва (Украински)](https://github.com/AndrewSavetchuk/33-js-concepts-ukrainian-translation) — Andrew Savetchuk
- [සිංහල (Синхалски)](https://github.com/ududsha/33-js-concepts) — Udaya Shamendra
- [Italiano (Италиански)](https://github.com/Donearm/33-js-concepts) — Gianluca Fiore
- [Malagasy (Малгашки)](https://github.com/chrys-elrak/33-js-concepts) — Chrys Rakotonimanana

---

## <a id="table-of-contents">Съдържание</a>

1. **[Повикващ стак (Call Stack)](#1-call-stack)**
2. **[Примитивни типове данни (Primitive Types)](#2-primitive-types)**
3. **[Стойностни (примитивни) и референтни типове данни (Value Types and Reference Types)](#3-value-types-and-reference-types)**
4. **[Имплицитни, експлицитни, номинални, структуриране и дък тайпинг (Implicit, Explicit, Nominal, Structuring and Duck Typing)](#4-implicit-explicit-nominal-structuring-and-duck-typing)**
5. **[Сравнение между ==, === и typeof (== vs === vs typeof)](#5--vs--vs-typeof)**
6. **[Функционален, регионен и лексикален обхват (Function Scope, Block Scope and Lexical Scope)](#6-function-scope-block-scope-and-lexical-scope)**
7. **[Израз срещу твърдение (Expression vs Statement)](#7-expression-vs-statement)**
8. **[IIFE (Незабавно Извикан Функционален Израз), Modules and Namespaces](#8-iife-modules-and-namespaces)**
9. **[Опашка на съобщенията и евент лууп (Message Queue and Event Loop)](#9-message-queue-and-event-loop)**
10. **[setTimeout, setInterval and requestAnimationFrame](#10-settimeout-setinterval-and-requestanimationframe)**
11. **[JavaScript Двигатели (JavaScript Engines)](#11-javascript-engines)**
12. **[Bitwise Operators, Type Arrays and Array Buffers](#12-bitwise-operators-type-arrays-and-array-buffers)**
13. **[DOM (документален обектен модел) and Layout Trees](#13-dom-and-layout-trees)**
14. **[Фабрики и класове (Factories and Classes)](#14-factories-and-classes)**
15. **[this, call, apply and bind](#15-this-call-apply-and-bind)**
16. **[new, Constructor, instanceof and Instances](#16-new-constructor-instanceof-and-instances)**
17. **[Прототипна наследственост и прототипна верига (Prototype Inheritance and Prototype Chain)](#17-prototype-inheritance-and-prototype-chain)**
18. **[Object.create and Object.assign](#18-objectcreate-and-objectassign)**
19. **[map, reduce, filter](#19-map-reduce-filter)**
20. **[Девствени функции, странични ефекти, Мутация на състоянието и изплуващо събитие (Pure Functions, Side Effects, State Mutation and Event Propagation)](#20-pure-functions-side-effects-state-mutation-and-event-propagation)**
21. **[Closures](#21-closures)**
22. **[Функции на висок ред (High Order Functions)](#22-high-order-functions)**
23. **[Рекурсия (Recursion)](#23-recursion)**
24. **[Колекции и генератори (Collections and Generators)](#24-collections-and-generators)**
25. **[Обещания (Promises)](#25-promises)**
26. **[async/await](#26-asyncawait)**
27. **[Дата структури (Data Structures)](#27-data-structures)**
28. **[Скъпи операции и нотация с голямо "О" (Expensive Operation and Big O Notation)](#28-expensive-operation-and-big-o-notation)**
29. **[Алгоритми (Algorithms)](#29-algorithms)**
30. **[Наследственост, полиморфизъм и повторно използване на код (Inheritance, Polymorphism and Code Reuse)](#30-inheritance-polymorphism-and-codе-reuse)**
31. **[Структуриране на кода (Design Patterns)](#31-design-patterns)**
32. **[Частични приложения, къринг, композиране и пренасочване (Partial Applications, Currying, Compose and Pipe)](#32-partial-applications-currying-compose-and-pipe)**
33. **[Чист код (Clean Code)](#33-clean-code)**
...
**[⬆ Обратно нагоре](#table-of-contents)**
